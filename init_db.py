...
SEED_COMMANDS: List[Dict[str, str]] = [
    # --- file ops -----------------------------------------------------------
    {"intent": "list files in current directory",           "command": "ls -la"},
    {"intent": "show current working directory",           "command": "pwd"},
    {"intent": "find files by name",                       "command": "find . -type f -name"},
    {"intent": "search text in files",                     "command": "grep -rn"},
    {"intent": "show file contents",                       "command": "cat"},
    {"intent": "show first lines of a file",               "command": "head -n 20"},
    {"intent": "show last lines of a file",                "command": "tail -n 20"},
    {"intent": "count lines in a file",                    "command": "wc -l"},
    ...
    {"intent": "show top processes by cpu",                "command": "ps aux --sort=-%cpu | head -11"},
    {"intent": "show top processes by memory",             "command": "ps aux --sort=-%mem | head -11"},
    ...
    # --- networking ---------------------------------------------------------
    {"intent": "show ip addresses",                        "command": "ip -4 addr show"},
    {"intent": "show open ports",                          "command": "ss -tulnp"},
    {"intent": "ping a host",                              "command": "ping -c 4"},
    {"intent": "show public ip",                           "command": "curl -s https://ifconfig.me"},
    {"intent": "show dns records for a domain",            "command": "dig +short"},
    {"intent": "trace route to a host",                    "command": "traceroute -m 15"},
    {"intent": "download a file with wget",                "command": "wget"},
    {"intent": "show network interfaces",                  "command": "ifconfig -a"},
    {"intent": "lookup dns for a domain",                  "command": "nslookup"},
    ...
    # --- system info --------------------------------------------------------
    {"intent": "show kernel and os info",                  "command": "uname -a"},
    {"intent": "show hostname",                            "command": "hostname"},
    {"intent": "show current date and time",               "command": "date"},
    {"intent": "show cpu info",                            "command": "lscpu"},
    {"intent": "show os release info",                     "command": "cat /etc/os-release"},
