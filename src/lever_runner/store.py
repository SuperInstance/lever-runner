...
class CommandStore:
    ...
    def teach(self, intent_phrase: str, command: str,
              trust: Optional[float] = None) -> str:
    ...
    def update_trust(self, row_id: str, *, success: bool,
                     trust_bump: float = 1.5,
                     trust_penalty: float = 4.0) -> None:
